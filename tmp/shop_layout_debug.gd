...
func _run() -> void:
	...
	print("DEBUG ", shop.size, " window ", shop.shop_window.size, " scroll ", shop.item_scroll.size, " grid ", shop.get_category_grid("all").size, " cols ", shop.get_category_grid("all").columns)
