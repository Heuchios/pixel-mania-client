...
func _ready():
	...
	setup_item_database()
	_record_join_stage("client_item_database_ready")
	setup_drop_manager()
	...
	_record_join_stage("client_core_managers_ready")
	...
	setup_seed_system()
	_record_join_stage("client_seed_system_ready")
	...
	_record_join_stage("client_inventory_ready")
	setup_save_manager()
	load_player_data()
