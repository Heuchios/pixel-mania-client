...
func _run() -> void:
	...
	var incomplete_join_lifecycle_source := source_between(network_source, "func has_incomplete_join_lifecycle_for_world", "func send_join_world_if_needed")
	assert(incomplete_join_lifecycle_source.contains("active_join_request_pending"))
	assert(incomplete_join_lifecycle_source.contains("world_entry_requires_ready and not world_entry_active"))
	assert(incomplete_join_lifecycle_source.contains("pending_server_world_state"))
	assert(incomplete_join_lifecycle_source.contains("pending_world_state_stream"))
	...
	assert(join_if_needed_source.contains("has_incomplete_join_lifecycle_for_world"))
